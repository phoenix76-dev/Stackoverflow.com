...
def ajax_get_tag_sticker(request):
    tag_obj = Tag.objects.get(id=int(request.GET.get('tag_id')))
    print(tag_obj)
    if tag_obj:
        ...
        response_text = response_text.format(followers, questions, description)
